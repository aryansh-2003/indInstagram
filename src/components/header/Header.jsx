...
function Header() {
    ...
    const navItems = [
        {
          ...
          slug: "/",
          image: (
            <svg aria-label="Home" className="w-6 h-6 hover:text-black text-white" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
              <title>Home</title>
        ...
        // },
        {
          ...
          slug: "/add-post",
          image: (
            <svg aria-label="New post" className="w-6 h-6 hover:text-black text-white" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
        ...
        },
        {
          ...
          slug: "/login",
          image: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48" height="48" role="img" aria-labelledby="loginCircleTitle" class="icon w-8 h-7 text-white  icon-login-circle">
                  <circle cx="24" cy="24" r="20" fill="none" stroke="currentColor" stroke-width="2.5"/>
                  <path d="M18 24h14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M28 18l6 6-6 6" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
          ),
          active: !authStatus,
        },
        ...
        },
        {
          ...
          slug: "/all-posts",
          image: (
            <svg aria-label="Profile" className="w-6 h-6 text-white hover:text-black" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
  ...
  return (
    <div className="md:fixed flex border-gray-900 flex-row md:flex-col items-center bottom-0 w-full fixed   md:left-0 md:top-0 md:h-full md:w-[20%] bg-black border-r z-200">
      {/* Logo Section */}
            ...
            item.active ? (
              <li key={item.name}>
                <button
                  ...
                  className="flex items-center gap-4 w-full p-3 text-white hover:text-black hover:bg-gray-50  rounded-lg transition-colors duration-200 group"
                >
                  {item.image && (
