        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-black">
                <div className="max-w-md mx-auto text-center p-8">
                    ...
                    <h1 className="text-2xl font-light text-white mb-4">Welcome to Instagram</h1>
                    <p className="text-gray-400 mb-8">Sign up to see photos and videos from your friends.</p>
                    <div className="space-y-4">
                        ...
                        onClick={() => navigate('/signup')}
                         className="block w-full border border-gray-300 text-white py-2 px-4 rounded-lg font-semibold hover:bg-gray-900 transition-colors">
                            Sign Up
                        </button>
                    </div>
                </div>
            ...
            <div className="min-h-screen bg-black">
                <div className="max-w-2xl mx-auto px-4 py-8">
                    <div className="text-center py-20">
                        ...
                        <h2 className="text-xl font-light text-white mb-2">No Posts Yet</h2>
                        <p className="text-gray-400 mb-6">When people you follow share photos, you'll see them here.</p>
                    ...
                    <div className="flex space-x-4 overflow-x-auto scrollbar-hide">
                        ...
                        {[1,2,3,4,5].map((i) => (
                            <div key={i} className="flex-shrink-0 text-center">
                                ...
                                <p className="text-xs mt-1 text-gray-400 truncate w-14">user{i}</p>
                            </div>
                        ))}
                    </div>
                </div>
