        ...
        <form onSubmit={handleSubmit(submit)} className="space-y-6">
            ...
            <div className="space-y-4">
                <label className="block">
                    <span className="text-sm font-medium text-gray-900 mb-2 block">Photo</span>
            ...
            <div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className={`px-6 py-2 bg-blue-500 text-white text-sm font-medium rounded-lg transition-colors ${
                        loading 
