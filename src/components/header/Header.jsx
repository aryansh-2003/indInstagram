    ...
    const navItems = [
        {
          ...
          slug: "/",
          image: (
            <svg aria-label="Home" className="w-6 h-6 text-white" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
              <title>Home</title>
        ...
        // },
        {
          ...
          slug: "/add-post",
          image: (
            <svg aria-label="New post" className="w-6 h-6 text-white" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
        ...
        },
        {
          ...
          slug: "/all-posts",
          image: (
            <svg aria-label="Profile" className="w-6 h-6 text-white" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
