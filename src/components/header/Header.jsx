...
function Header() {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-60 bg-white border-r border-gray-200 z-50 flex flex-col">
      {/* Logo Section */}
      ...
      <div className="px-3 py-4 border-t border-gray-100">
        <div className="space-y-1">
          <button className="flex items-center gap-4 w-full p-3 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors duration-200">
            <svg aria-label="Settings" className="w-6 h-6" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
              <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="3" x2="21" y1="6" y2="6"></line>
              <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="3" x2="21" y1="12" y2="12"></line>
              <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="3" x2="21" y1="18" y2="18"></line>
            </svg>
